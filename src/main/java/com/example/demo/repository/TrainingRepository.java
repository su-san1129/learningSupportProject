...
public class TrainingRepository {
	...
	private final RowMapper<Training> TRAINING_ROWMAPPER = (rs, i) -> {
		...
		String instructorName = rs.getString("i_id");
		...
		if (subInstructor1Id != 0) {
			String subInstructorName = rs.getString("s1_id");
		...
		if (subInstructor2Id != 0) {
			String subInstructorName2 = rs.getString("s2_id");
		...
		if (subInstructor3Id != 0) {
			String subInstructorName3 = rs.getString("s3_id");
